# -*- coding: utf-8 -*-
"""
Created on Fri Jul 30 20:44:19 2021
...
class FullBodyPoseEmbedder(object):
  ...
  def _get_pose_distance_embedding(self, landmarks):
    ...
    embedding = np.array([
        ...
        #self._get_distance_by_names(landmarks, 'left_pinky_1', 'left_elbow'),
        #self._get_distance_by_names(landmarks, 'right_pinky_1', 'right_foot_index'),
        
        
        #self._get_distance_by_names(landmarks, 'left_pinky_1', 'left_elbow'),
        #self._get_distance_by_names(landmarks, 'right_pinky_1', 'right_elbow'),
        
        
        self._get_distance_by_names(landmarks, 'left_knee', 'left_foot_index'),
        self._get_distance_by_names(landmarks, 'right_knee', 'right_foot_index'),
...
class BootstrapHelper(object):
  ...
  def bootstrap(self, per_pose_class_limit=None):
    ...
    for pose_class_name in self._pose_class_names:
      ...
      with open(csv_out_path, 'w', newline='') as csv_out_file:
        ...
        #image_names.remove('desktop.ini')
  ...
  def print_images_in_statistics(self):
    ...
    print(os.path.realpath(self._images_in_folder))
  ...
  def _print_images_statistics(self, images_folder, pose_class_names):
    if 'desktop.ini' in pose_class_names:
        pose_class_names.remove('desktop.ini')
